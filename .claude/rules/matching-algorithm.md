...
5. **ソフト目的関数 (辞書式優先)**:
   ...
   2. 男女 2:2 卓数を最大化 (4 人卓のうち 2:2 になる卓数)
   3. 同性のみ卓を最小化 (混合卓最大化)
...
- **ソフト目的検証**: 相互投票 rank 合計が辞書式最優先で最大化されていること (男女 2:2 は辞書式第2位)
- **Min-Regret**: 固定入力に対する既知の最適解を返す (ゴールデンテスト 3 ケース以上)
- **境界値**: 3 vs 3、3 vs 5 (5 対 3 の逆も)、0 vs N
...
- [tomokoi-guardrails.md](tomokoi-guardrails.md) — Votes のみ入力
