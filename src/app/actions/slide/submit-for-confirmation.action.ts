...
import { submitForConfirmationUseCase } from '@/application/slide/use-cases/submit-for-confirmation.use-case';
...
export async function submitForConfirmationAction(
  input: unknown,
  ...
  const result = await submitForConfirmationUseCase(asDeckId(parsed.data.deckId), {
