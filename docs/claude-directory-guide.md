...
| `team-boundaries.md`      | `src/**`                                                  | A/B/C/D レーン境界・クロスメンバー型契約 (`types/api.ts`) は B（PM）管轄            | `tomokoi-guardrails.md`                   |
...
| ---------------------------------------- | -------------------------------------------------------- | -------------------------------------- | ------------------------------------------------------------- |
| A (スライド・管理・DB基盤)               | `/member-a-slide` `/database-migration` `/phase0-check`  | `gemini-prompt-reviewer` `rls-auditor` | `ai-gemini-prompts.md` `supabase-rls.md` `team-boundaries.md` |
| B (PM・VRM・MediaPipe・クロスメンバー型) | `/member-b-avatar`                                       | —                                      | `vrm-avatar.md` `team-boundaries.md`                          |
